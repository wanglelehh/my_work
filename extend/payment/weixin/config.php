...
return array(
    ...
    'config' => array(
        ...
        array('name'=>'apiclient_cert_pem','label'=>'证书pem格式','type'=>'file','value'=>'','is_must'=>0,'tip'=>'apiclient_cert.pem，(微信提现到零钱)需要配置'),
        array('name'=>'apiclient_key_pem','label'=>'密钥pem格式','type'=>'file','value'=>'','is_must'=>0,'tip'=>'apiclient_key.pem，(微信提现到零钱)需要配置'),
    ),
);