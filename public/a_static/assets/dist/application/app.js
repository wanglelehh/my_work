    ...
    define("dist/application/element", ["$", "dist/application/setting", "dist/application/method"],
        function (a) {
            ...
            b(document).on("click", '[data-toggle="trigger"]',
                ...
                b(document).on("click", '[data-toggle^="class"]',
                    function (a) {
                        ...
                        var d, f, g, h, i, j = b(a.target);
                        !j.data("toggle") && (j = j.closest('[data-toggle^="class"]')),
                            d = j.data().toggle,
                ...
                //自定义byiqgmy
                b(document).on("click", '[data-dismiss="modal"]', function (c) {
                    if (b('#_ajaxModal').length > 0){
                        $('#ajaxModal').show();
                        b('#_ajaxModal').remove();
                        return true;
                    }
                    b('.modal-backdrop').remove();
                }),
                ...
                b(document).on("click", '[data-toggle="ajaxModal"]',
                    function (c) {
                        ...
                        if (typeof(cw) == 'undefined') {
                            b("#ajaxModal").remove();
                            var g = b('<div class="modal fade" id="ajaxModal"><div class="modal-body "></div></div>')
                        } else {
                            b("#ajaxModal").hide();
                            b('.modal-backdrop').remove();
                            b("#_ajaxModal").remove();
                            var g = b('<div class="modal fade" id="_ajaxModal"><div class="modal-body "></div></div>')
                        }
                        if (sf) {
                                ...
                                g.append2(c,
                                    function () {
                                        ...
                                        c.length > 0 && a.async("dist/form/init",
                                            ...
                                            d.trigger("init", g);
                                        var dd = b('form.form-modal [data-toggle="datetimepicker"]');
                                        dd.length > 0 && a.async(["moment", "datetimepicker", assets_path + "/main/css/stylesheets/datetimepicker/datetimepicker.min.css"],
                                            function () {
                                                dd.each(function () {
                                                    _datetimepicker(b(this));
                                                })
                                            });
                                        var ee = b('form.form-modal [data-toggle="select2"]');
                                        ee.length > 0 && a.async(["select2"],
                                            function () {
                                                ee.each(function () {
                                                    var a = b(this),
                                                        d = {},
                                                    ...
                                                    if (e && (d.maximumSelectionSize = e), g) {
                                                        ...
                                                        b(i).on("click", 'button[type="submit"]',
                                                            function () {
                                                                var b = a.val();
                                                                return b ? void 0 : (G.ui.tips.suc(h || "请输入必填项"), !1)
                                                            })
                                                    }
                                                    if (f) switch (f) {
                                                        case "submit":
                ...
                b(document).on("click", '[data-toggle="iframeModal"]',
                    function (c) {
                        ...
                        var d = b(this),
                            url = d.data("url"),
                            urlfun = d.data("urlfun"),
                            title = d.data("title"),
                            g = b('<div class="modal fade" id="ajaxModal"><div class="modal-body "></div></div>');
                        if (typeof(urlfun) !== 'undefined') {
                            url = eval(urlfun + '()');
                        }
                        ...
                        b(document).append(g),
                            ...
                            g.append2('<div class="modal-dialog"><div class="modal-content" style="min-width: 700px;">' +
                                ...
                                '<h4 class="modal-title"><i class="icon-table"></i>' + title + '</h4></div> ' +
                ...
                b(document).on("click", '[data-toggle="ajaxCurl"]',
                    function (a) {
                        a.preventDefault();
                        var c = b(this),
            ...
            b(document).on("click", '[data-toggle="ajaxPost"]',
                ...
                b(document).on("click", '[data-toggle="wrapperAjax"]',
                    function (a) {
                        a.preventDefault();
                        var e = b(this),
                            f = e.attr("href");
                        if ($('.vbox').find('.wrapper-box').length < 1){
                            $('.vbox').append('<div class="wrapper-mask"></div>');
                            $('.vbox').append('<div class="wrapper-box"><div class="_info"></div></div>');
                            $(document).on("click",'.wrapper-mask',function(){
                                 $(this).remove();
                                 $('.wrapper-box').remove();
                                 $(document).off("click",'.wrapper-mask');
                            });
                        }
                        b.ajax(f, {
                            type: "get",
                            ...
                            $('.wrapper-box ._info').html(c);
                            $('.wrapper-box').addClass('move-left');
                        })
                        return false;

                }),
                b(document).on("hover", '[data-toggle="uploaderOne"]',
                    function (c) {
                        var $el = b(this),
                            fun = $el.data("fun"),
                            file_type = $el.data("file_type") || "picture",
                            type = $el.data("type")?$el.data("type"):'image',
                            is_uploader = $el.data('is_uploader'),
                            upload_path = $el.data("uploadpath"),
                            showloading = $el.data("showloading"),
                            deftext = $el.html(),
                        ...
                        $el.data('is_uploader','true');
                        a.async("dist/plupload/file",
                            function () {
                                var isError = false;
                                $el.uploader({
                                    multi: 0,
                                    url: upload_path+'?type='+type,
                                    data: datas,
                                    FilesAdded: function(a, b) {
                                        $.each(b,
                                            function(a, b) {
                                                $el.find('.tips').html('开始上传');
                                            })
                                    },
                                    UploadProgress: function(a, b) {
                                        $el.find('.tips').html(b.percent+'%');
                                        if (showloading == true) {
                                            if (b.percent == 100){
                                                $el.html('后端正在处理...');
                                            }else{
                                                $el.html('正在上传:' + b.percent + '%');
                                            }
                                        }
                                    },
                                    FileUploaded: function(a, b, c) {
                                        ...
                                        if ($el.find('input').length > 0){
                                            $el.find('input').val(c.url);
                                            $el.find('img').attr('src',c.url);
                                            if (c.image_id){
                                                $el.find('input').attr('data-img_id',c.image_id);
                                            }
                                        }else{
                                            $el.parent().find('img').attr('src',c.url);
                                            $el.find('input').val(c.url);
                                        }
                                    ...
                                    UploadComplete: function() {
                                        if (isError == true){
                                            $el.find('.tips').html('点击上传');
                                        }else{
                                            $el.find('.tips').html('上传成功');
                                        }
                                        isError = false;
                                    }
                            },file_type)
                ...
                b(document).on("click", '[data-toggle="uploaderImg"]',
                    function (c) {
                        var $el = b(this),
                            fun = $el.data("fun");
                            uploaderImgToggle = $el;
                            b("#webuploader_ajaxModal").remove();
                        ...
                        var g = b('<div class="modal fade upload_modal" id="webuploader_ajaxModal"  data-filenumlimit="1" data-type="uploaderImg"><div class="modal-body "></div></div>');
                            g.modal(),
                            g.append2('<div class="modal-dialog"><div class="modal-content" style="min-width: 700px;">' +
                                '<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>' +
                                ...
                                '<div class="queueList"><div id="dndArea" class="placeholder"><div id="filePicker"></div><p>或将照片拖到这里</p></div></div>' +
        ...
        function (a) {
            ...
            h.length > 0 && a.async(["moment", "daterangepicker"],
                function () {
                    h.each(function () {
                        var a = b(this);
                        a.find('span').html(a.find('input[name="reportrange"]').val());//add by iqgmy
                        ...
                        a.daterangepicker({
                            ...
                            function (c, d) {
                                ...
                                b("span", a).html(e),
                                    b('input[name="reportrange"]', a).val(e);
                                var f = a.data("change");
                                if (f) switch (f) {
                                    case "submit":
                                        a.closest("form ").submit()
                                        ...
                                        switch (this.defaults_file_type) {
                                            case "big_picture":
                                                d.defaults.max_file_size = "20mb",
                                                    ...
                                                    plupload.addI18n({
                                                        "File extension error.": "图片格式必须为以下格式：jpeg, jpg, png",
                                    ...
                                    this.options = b.extend(!0, {},
                                        ...
                                        this.plupload = new plupload.Uploader({
                                            ...
                                            init: {
                                                FilesAdded: function (a, b) {
                                                    //a.files.length
                                                    var length = $(e.element).parent().parent().find('.js_fileList li').length;
                                                   // console.log(length);//iqgmy
                                                    return e.options.max_count && length >= e.options.max_count ? (G.ui.tips.info("最多上传{0}个文件".format(e.options.max_count)), plupload.each(b,
                                                        function (b) {
                                                            a.removeFile(b)
...
//日期选择
function _datetimepicker(a){
    var c = a.data("minutestep") || 5,
