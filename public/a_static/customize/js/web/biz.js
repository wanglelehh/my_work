define(['jquery'],
    function($) {
        ...
        biz.selector = {
            select: function(params) {
                ...
                if (modalObj.length <= 0) {
                    ...
                    modal += '<span class="input-group-btn"><button type="button" id="query-btn" class="btn btn-default" onclick="biz.selector.search( \'' + name + '\');">搜索</button></span>';
                    modal += '</div>';
                    modal += '</div>';
                ...
                var that = this;
                if (params.autosearch == 1 && $('.content', modalObj).html() == "") {
                    setTimeout(function (){
                        that.search(name);
                    },200);
                }
            ...
            set: function(obj, data) {
                ...
                if (type == 'image') {
                    ...
                    html += '<img class="img-responsive img-thumbnail" src="' + data[thumb] + '" onerror="this.src=\'/a_static/customize/images/nopic.png\'">';
        ...
        biz.map = function(val, callback, tpl) {
            ...
            modalobj.find('button.btn-primary').on('click',
                function() {
