require.config({
    ...
    paths: {
        ...
        "jquery.ui": "jquery/jquery-ui-1.10.3.min",
        ...
        "jquery.jplayer": "jquery/jplayer/jquery.jplayer.min",
    ...
    shim: {
        ueditor: {
            deps: ["/a_static/customize/js/components/ueditor/third-party/zeroclipboard/ZeroClipboard.min.js", "/a_static/customize/js/components/ueditor/ueditor.config.js"],
            exports: "UE",
            init: function (a) {
