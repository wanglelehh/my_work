...
class Index extends AdminController
{
    ...
    public function stats(){
        ...
        $withdrawLogNum = (new WithdrawLogModel)->where($where)->count('log_id');
        unset($where);
        ...
        while ($dt_start <= strtotime($end_day)) {
            ...
            if ($dt_start == $today) {
                ...
                $stats['today']['order_pay_amount'] = $data['order_amount'] * 1;
                ...
                $stats['yesterday']['order_pay_amount'] = $data['order_amount'] * 1;
