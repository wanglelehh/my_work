...
class AdminUserModel extends BaseModel
{
    ...
    public function login($data)
    {
       ...
       $this->saveDate(['user_id'=>$user['user_id'],'login_time'=>time(),'login_ip'=>get_client_ip(),'last_login_time'=>$user['login_time'],'last_login_ip'=>$user['login_ip']],'login');
    ...
    {
		$data = self::getRows();
        return empty($data[$user_id])==false?$data[$user_id]:[];
    }
	//*------------------------------------------------------ */
	//-- 更新数据
	/*------------------------------------------------------ */
